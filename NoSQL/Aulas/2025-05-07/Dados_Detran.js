...
db.infracao.insertMany([
    ...
    {_id: 1, descricao: "Excesso, de até 20%, da velocidade máxima permitida no trajeto.", pontos: 5, valor: 85.15},
    {_id: 2, descricao: "Avanço de sinal vermelho do semáforo ou de parada obrigatória.", pontos: 7, valor: 293.47},
    {_id: 3, descricao: "Ausência do cinto de segurança.", pontos: 5, valor: 195.32}
...
db.multa.insertMany([
    ...
    {_id: 12, lancamento: "Condutor tocando música de domingo a noite.", local: "Vale da Sofrência", horario_multa: ISODate("2025-12-31T11:30:00Z"), id_veiculo: 1, id_cidade: 1, id_infracao: 3, id_agente: 2}
